"""
This DAG serves as an exmaple to show case how to orchestrate workloads running across subscriptions/workspaces.
This may become handy for scenarios like Federated Learning, etc.
"""
...
with DAG(
    ...
    silo1_pipeline_task = AzureMachineLearningCreateJobOperator(
        task_id="slio1_pipeline_iteration",
        job=pipeline_job,
        waiting=True,
        conn_id=connection_id,
    )

    connection_id = "AML_2ND_SUB"
    silo2_pipeline_task = AzureMachineLearningCreateJobOperator(
        task_id="silo2_pipeline_iteration",
        job=pipeline_job,
        waiting=True,
        conn_id=connection_id,
    )
    ...
    start_task >> [silo1_pipeline_task, silo2_pipeline_task] >> success_task
